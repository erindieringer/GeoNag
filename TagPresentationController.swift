//
//  TagPresentationController.swift
//  iOSApp
//
...
class TagPresentationController: UIPresentationController, UIAdaptivePresentationControllerDelegate {
    ...
    override init(presentedViewController: UIViewController, presentingViewController: UIViewController) {
        ...
        let tap = UITapGestureRecognizer(target: self, action: #selector(TagPresentationController.chromeViewTapped(_:)))
